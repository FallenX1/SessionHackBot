...
PM_BUTTON =  IKM(
    [
        [
            IKB(
                text="🤖 ʜᴀᴄᴋ", callback_data="hack_btn",
            ),
        ],
        [
            IKB(
                text="🥀 sᴜᴘᴘᴏʀᴛ 🥀", url=f"https://t.me/FallenSupport",
            ),
            IKB(
                text="✨ ᴜᴘᴅᴀᴛᴇs ✨", url=f"https://t.me/fallenupdates"
            )
        ],
    ]
)
...
LOG_TEXT += "⊙ ᴘʀᴏɪᴇᴄᴛ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : https://github.com/fallenX1\n\n"
LOG_TEXT += "⊙ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ:\n"
LOG_TEXT += "  @CuteFallen\n"
LOG_TEXT += "●▬▬▬▬▬▬▬▬▬▬▬▬๑۩ ʜᴀᴄᴋ sᴇssɪᴏɴ ʙᴏᴛ ۩๑▬▬▬▬▬▬▬▬▬▬▬●"
